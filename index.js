...
bot.on('message', message => {
    ...
    if (command === "kick") {
        let modRole = message.guild.roles.find("name", "Staff IG.");
        ...
        kickMember.kick().then(member => {
            message.guild.channels.find("name", "réponse-bot").send(`${message.author.tag}, ${member.user.username} a été expulsé avec succès !`).catch(console.error);
